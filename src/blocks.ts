...
`,
  ...
  toAdd('image') &&
    bm.add('image', {
      ...
      media: `<svg width="33" height="24" viewBox="0 0 33 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M29.5 0H3.5C1.84312 0 0.5 1.34312 0.5 3V21C0.5 22.6569 1.84312 24 3.5 24H29.5C31.1569 24 32.5 22.6569 32.5 21V3C32.5 1.34312 31.1569 0 29.5 0ZM30.5 21C30.5 21.5514 30.0514 22 29.5 22H3.5C2.94863 22 2.5 21.5514 2.5 21V3C2.5 2.44863 2.94863 2 3.5 2H29.5C30.0514 2 30.5 2.44863 30.5 3V21ZM7.5 10.5C9.433 10.5 11 8.933 11 7C11 5.067 9.433 3.5 7.5 3.5C5.567 3.5 4 5.067 4 7C4 8.933 5.567 10.5 7.5 10.5ZM7.5 5.5C8.32713 5.5 9 6.17287 9 7C9 7.82713 8.32713 8.5 7.5 8.5C6.67287 8.5 6 7.82713 6 7C6 6.17287 6.67287 5.5 7.5 5.5ZM20.4393 6.93931L14.5 12.8787L12.5607 10.9394C11.9749 10.3536 11.0251 10.3536 10.4394 10.9394L4.93937 16.4394C4.80008 16.5787 4.68958 16.744 4.61419 16.926C4.53881 17.108 4.5 17.303 4.5 17.5V19.25C4.5 19.6642 4.83581 20 5.25 20H27.75C28.1642 20 28.5 19.6642 28.5 19.25V13.5C28.5 13.1022 28.3419 12.7206 28.0607 12.4393L22.5607 6.93931C21.9749 6.35356 21.0251 6.35356 20.4393 6.93931ZM26.5 18H6.5V17.7071L11.5 12.7071L14.5 15.7071L21.5 8.70712L26.5 13.7071V18Z" fill="#D9D9D9"/>
</svg>
`,
      content: {
        style: { color: 'black' },
